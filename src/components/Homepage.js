...
export default function Homepage() {
	return(
		<div className="max-w-[1300px] mx-auto sm:px-[50px] px-[20px] font-['Lexend_Deca']">
			<Header />
			<div className="mt-[20px] sm:flex justify-between items-top sm:gap-[50px]">
				<div className="text-[#37405E] min-[1200px]:max-w-[600px]">
					<div className="sm:text-[36px] text-[30px]">
			...
			<div className="mt-[100px] text-[#37405E] text-center">
				<div className="sm:text-[36px] text-[30px]">Why Choose Fair Field?</div>
			...
			<div className="mt-[100px] text-[#37405E] text-center">
				<div className="sm:text-[36px] text-[30px]">Location & Accessibility</div>
			...
			<div className="mt-[100px]">
				<div className="flex gap-[50px] items-center justify-between">
					<div className="min-[1200px]:max-w-[620px]">
						<div className="sm:text-[36px] text-[30px] text-[#37405E]">Book Your Exclusive Site Visit</div>
